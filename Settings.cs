...
public static class Settings
{
    ...
    public static readonly string JeekEasytierManagerZipUrl = "https://github.com/tifish/JeekEasytierManager/releases/download/latest_release/JeekEasytierManager.zip";
